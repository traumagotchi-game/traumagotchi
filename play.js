...
function draw() {
  ...
  switch (state) {
    ...
    case 'care':
      ...
      // visibility toggles view on/off but it still occupies space
      // careMenu.style.visibility = "visible";
    ...
    case 'game':
      ...
      // careMenu.style.visibility = "hidden";
...
function login() {
  ...
  // use toUpperCase() to make case insensitive
  // console.log(keys);
